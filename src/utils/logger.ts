...
export default class Logger {
  ...
  private static isLogLevel: any = {
    ...
    info: () => {
      return Logger.logLevel === Logger.LOG_LEVELS.DEBUG || Logger.logLevel === Logger.LOG_LEVELS.INFO;
    },
    error: () => {
      return Logger.logLevel === Logger.LOG_LEVELS.DEBUG || Logger.logLevel === Logger.LOG_LEVELS.ERROR;
    },
  };
